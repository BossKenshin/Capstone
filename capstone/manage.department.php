            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="container">
                        ...
                        <input class="form-control mb-2" type="text" id="deptname" placeholder="Name..." aria-label="default input example">

                        <label for="deptabb"> Abbreviation</label>
                        <input class="form-control mb-2" type="text" id="deptabb" placeholder="Abbreviation..." aria-label="default input example">

                        <label for="deptusername"> Username</label>
                        <input class="form-control mb-2" type="text" id="deptusername" placeholder="Username here..." aria-label="default input example">

                        <label for="deptpassword"> Password</label>
                        <input class="form-control mb-2" type="text" id="deptpassword" placeholder="Password here..." aria-label="default input example">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="container">
                        ...
                        <label for="deptname">Department Name</label>
                        <input class="form-control mb-2" type="text" id="newdeptname" placeholder="Name..." aria-label="default input example">

                        <label for="deptabb"> Abbreviation</label>
                        <input class="form-control mb-2" type="text" id="newdeptabb" placeholder="Abbreviation..." aria-label="default input example">

                        <label for="deptusername"> Username</label>
                        <input class="form-control mb-2" type="text" id="newdeptusername" placeholder="Username here..." aria-label="default input example">

                        <label for="deptpassword"> Password</label>
                        <input class="form-control mb-2" type="text" id="newdeptpassword" placeholder="Password here..." aria-label="default input example">
